...
var SYNONYMS_ = {
  ...
  adp: 'portal adp ponto contracheque expert',
  expert: 'adp portal expert',
  // Vocabulário de primeiro acesso / cadastro no portal
  registro: 'primeiro acesso cadastro registro adp',
  registrar: 'primeiro acesso cadastro registro adp',
  cadastrar: 'primeiro acesso cadastro registro adp',
  inscricao: 'primeiro acesso cadastro registro adp',
  login: 'acesso login senha usuario',
  senha: 'senha login acesso credencial usuario',
  usuario: 'usuario login acesso senha',
  acesso: 'acesso login primeiro senha',
